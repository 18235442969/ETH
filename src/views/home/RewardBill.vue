<template>
  <div class="rewardBill" id="rewardBill">
...
export default {
  ...
  methods: {
    ...
    initScroll() {
      //初始化滚动加载
      const that = this;
      document.getElementById('rewardBill').onscroll= function(){
        const bodyHeight = document.getElementById('rewardBill').scrollHeight;
        const clientHeight = document.getElementById('rewardBill').clientHeight;
        const scrollAllHeight = bodyHeight - clientHeight;
        const scrollTop = document.getElementById('rewardBill').scrollTop;
